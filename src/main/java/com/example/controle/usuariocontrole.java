...
public class usuariocontrole {
    ...
    public List<usuario> Consulta_todos_usuarios() {
        ...
        String CONSULTA_USUARIO ="SELECT id_usr,login,senha FROM usuario ORDER BY login";
        try{
    ...
    public boolean testaUsuario(String nome) {
        String PESQUISA_POR_NOME="SELECT id_usr FROM usuario WHERE login ='"+nome+"'";
        boolean ret=false;
        try{
            SQLiteDatabase bd=banco.getReadableDatabase();
    ...
    public boolean checkusuario(String nome, String senha) {
        String PESQUISA_POR_NOME_SENHA="SELECT id_usr  FROM usuario WHERE login ='"+nome+"' AND login='"+senha+"'";
        boolean ret=false;
        try{
            SQLiteDatabase bd=banco.getReadableDatabase();
